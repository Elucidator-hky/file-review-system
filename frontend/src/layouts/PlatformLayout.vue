    ...
    <el-container>
      ...
      <el-header class="layout-header">
        <div class="header-left">
          <h1 class="system-title">平台管理员</h1>
        </div>
      ...
      <el-container>
        ...
        <el-aside width="200px" class="layout-aside">
          ...
          >
            ...
            <el-menu-item index="/platform/monitor/queues">
              <el-icon><Histogram /></el-icon>
              <span>队列监控</span>
            </el-menu-item>
            <el-menu-item index="/platform/monitor/cache">
...
import { User, ArrowDown, OfficeBuilding, Histogram, PieChart } from '@element-plus/icons-vue'
