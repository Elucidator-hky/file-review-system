    ...
    <el-container>
          ...
          <el-dropdown @command="handleCommand">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                ...
                <el-dropdown-item v-if="userStore.isDualRole" command="switchRole" divided>切换到审查员</el-dropdown-item>
      ...
      <el-container>
        ...
        >
          ...
          <el-menu-item index="/user/my-tasks">
            <el-icon><Document /></el-icon>
            <span>我的任务</span>
          </el-menu-item>
          <el-menu-item index="/user/create-task">
...
import { User, ArrowDown, Document, EditPen, DataAnalysis } from '@element-plus/icons-vue'
...
const handleCommand = (command) => {
  if (command === 'logout') {
    ...
    // 切换到审查员角色
    if (userStore.switchRole('REVIEWER')) {
      ElMessage.success('已切换到审查员')
